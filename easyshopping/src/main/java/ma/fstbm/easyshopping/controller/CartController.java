...
import ma.fstbm.easyshopping.service.CartService;
...
public class CartController {
	...
	public String udpateCartLine(@PathVariable Long cartLineId, @RequestParam int count) {
	...
	public String removeCartLine(@PathVariable Long cartLineId) {
